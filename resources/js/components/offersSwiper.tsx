...
import {
    Euro, CalendarCheck, CalendarDays, MapPin, MessageCircle,
    ChevronsRight, ChevronLeft, ChevronRight
} from 'lucide-react';
...
// karta slajdu — 2 kolumny: (lewa) stawka/start/miasto, (prawa) czas/lang
function SlideCard({
                       slide,
                   }: {
    slide: {
