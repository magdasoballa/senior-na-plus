...
export default function Index(){
    const { skills, filters } = usePage<{ skills:Paginated<Row>; filters:{q?:string} }>().props
    ...
    return (
        <AdminLayout>
            <main className="p-6">
                <div className="text-sm text-slate-500">Zasoby › Umiejętności</div>
                <div className="mt-1 flex items-center justify-between">
                    <h1 className="text-2xl font-bold">Umiejętności</h1>
                    <Link href={`${BASE}/create`} className="rounded-lg bg-mint px-3 py-1 font-semibold text-white hover:brightness-110">Utwórz Umiejętność</Link>
                </div>
