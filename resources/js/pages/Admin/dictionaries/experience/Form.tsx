...
export default function Form(){
    ...
    return (
        <AdminLayout>
            <main className="p-6">
                <div className="text-sm text-slate-500">Zasoby › Doświadczenia w opiece › {isEdit ? `Aktualizacja ${row!.name_pl}` : 'Utwórz'}</div>
                <p className="mt-1 text-2xl font-bold">
                    {isEdit ? `Aktualizacja Doświadczenie w opiece: ${row!.id}` : 'Utwórz Doświadczenie w opiece'}
                </p>
                ...
                <form onSubmit={submit} className="mt-6 overflow-hidden rounded-xl border bg-white">
                    ...
                    <div className="border-b p-6">
                        ...
                        <input
                            ...
                            placeholder={lang==='pl' ? 'np. do 1 roku' : 'z. B. bis 1 Jahr'}
                        />
                    ...
                    <div className="flex items-center justify-end gap-3 p-6">
                        ...
                        <button type="submit" className="rounded-lg bg-mint px-4 py-2 font-semibold text-white" disabled={form.processing}>
                            {isEdit ? 'Aktualizacja Doświadczenie w opiece' : 'Utwórz Doświadczenie w opiece'}
                        </button>
                    </div>
                </form>
            </main>
