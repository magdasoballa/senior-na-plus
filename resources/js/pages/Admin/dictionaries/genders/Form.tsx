...
export default function Form(){
    ...
    return (
        <AdminLayout>
            <main className="p-6">
                <div className="text-sm text-slate-500">Zasoby › Płcie osób do opieki › {isEdit ? `Aktualizacja ${row!.name_pl}` : 'Utwórz'}</div>
                ...
                <form onSubmit={submit} className="mt-6 overflow-hidden rounded-xl border bg-white">
                    ...
                    <div className="border-b p-6">
                        ...
                        <input
                            ...
                            placeholder={lang==='pl' ? 'np. Kobieta' : 'z. B. Frau'}
                        />
                    ...
                    <div className="flex items-center justify-end gap-3 p-6">
                        ...
                        <button type="submit" className="rounded-lg bg-mint px-4 py-2 font-semibold text-white" disabled={form.processing}>
                            {isEdit ? 'Aktualizacja Płeć osoby do opieki' : 'Utwórz Płeć osoby do opieki'}
                        </button>
                    </div>
                </form>
            </main>
