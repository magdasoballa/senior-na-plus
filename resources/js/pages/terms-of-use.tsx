        ...
        <div className="mx-auto max-w-4xl px-4 py-10 prose prose-sm sm:prose-base">
            ...
            <section>
                ...
                <ol>
                    ...
                    <li><strong>Serwis</strong> – należący do Usługodawcy serwis internetowy, dostępny na stronie: www.seniornaplus.pl.</li>
                    ...
                    <li><strong>Formularz Rekrutacyjny</strong> – udostępniony w Serwisie pod adresem https://seniornaplus.pl/formularz lub na stronie głównej https://seniornaplus.pl/ (górna sekcja) formularz służący do złożenia aplikacji w celu podjęcia pracy u Usługodawcy. Prawidłowe wypełnienie Formularza Rekrutacyjnego oraz wyrażenie niezbędnych zgód na przetwarzanie Danych Osobowych, a także akceptacja Warunków Korzystania z Serwisu oraz Polityki Prywatności Serwisu są niezbędne do prawidłowego wysłania aplikacji.</li>
                    ...
                    <li><strong>Formularz Kontaktowy</strong> - formularz udostępniony w Serwisie pod adresem: https://seniornaplus.pl/kontakt, umożliwiający Użytkownikom kontakt z Usługodawcą, w tym m.in. skierowanie zapytania do Serwisu. Prawidłowe wypełnienie Formularza Kontaktowego oraz wyrażenie niezbędnych zgód na przetwarzanie Danych Osobowych, a także akceptacja Warunków Korzystania z Serwisu oraz Polityki Prywatności Serwisu są niezbędne do prawidłowego wysłania zapytania.</li>
                    ...
                    <li><strong>Polityka Prywatności</strong> – niniejsza polityka prywatności Serwisu udostępniona w zakładce pn. „Polityka Prywatności", pod adresem: https://seniornaplus.pl/polityka-prywatnosci.</li>

                    <li><strong>Warunki Korzystania</strong> – niniejsze Warunki Korzystania, udostępnione w zakładce pn. „Warunki korzystania", pod adresem: kontakt@seniornaplus.pl</li>
                </ol>
            </section>
            ...
            <section>
                ...
                <ol>
                    <li>Umowa o Świadczenie Usług zostaje zawarta z Użytkownikiem z chwilą rozpoczęcia korzystania z Usług Serwisu, po uprzednim wyrażeniu niezbędnych zgód na przetwarzanie Danych Osobowych, akceptacji Warunków Korzystania oraz Polityki Prywatności Serwisu.</li>
                    ...
                    <li>
                        ...
                        <ol className='ml-5'>
                            ...
                            <li>akceptuje zapisy Polityki Prywatności.</li>
                        </ol>
                    </li>
                    ...
                    <li>
                        ...
                        <ol className='ml-5'>
                            ...
                            <li>skorzystania z pozostałych uprawnień w zakresie ochrony jego Danych Osobowych, które zostały określone w Polityce Prywatności Serwisu.</li>
                        </ol>
                    </li>
            ...
            <section>
                ...
                <ol>
                    <li>Usługobiorcy mają prawo składać reklamacje w sprawach dotyczących realizacji Usług, Reklamacja powinna być przesłana drogą mailową bezpośrednio na adres kontaktowy <strong>kontakt@seniornapius.pl</strong> Reklamacja jest rozpatrywana przez Usługodawcę.</li>
            ...
            <section>
                ...
                <ol>
                    <li>Każdy Usługobiorca ma prawo do ochrony Danych Osobowych przez Usługodawcę. Polityka Prywatności jest dostępna bezpośrednio w Serwisie pod adresem: https://seniornaplus.pl/polityka-prywatnosci.</li>
                    ...
                    <li>W sprawach związanych z ochroną danych i realizacją swoich praw Usługobiorca może kontaktować się mailowo na adres: iod@seniornaplus.pl.</li>
                    ...
                    <li>
                        ...
                        <ol>
                            ...
                            <li>operatorzy portali społecznościowych i serwisów internetowych o których mowa w rozdziale XII Polityki Prywatności,</li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ol className='ml-5'>
                            ...
                            <li>usunięcia przez Usługobiorcę adresu poczty elektronicznej, która była użyta do wysyłania Newslettera,</li>
