...
export default function PrivacyPolicyFull() {
    return (
        ...
        <div className="mx-auto max-w-4xl px-4 py-10 prose prose-sm sm:prose-base">
            ...
            <ol>
                <li>
                    <strong>Administrator Danych Osobowych/ADO</strong> – spółka Senior na Plus Pflege sp. z o.o. z siedzibą w Warszawie (02-662) przy ul. S wieradowskiej 47, zarejestrowana w rejestrze
                    przedsiębiorco w Krajowego Rejestru Sądowego prowadzonego przez Sąd Rejonowy dla
                ...
                <li>
                    <strong>Serwis</strong> – należący do ADO serwis internetowy, dostępny na stronie: <a href="http://www.seniornaplus.pl/">www.seniornaplus.pl</a>.
                </li>
                <li>
                ...
                <li>
                    <strong>Warunki Korzystania</strong> – warunki korzystania z Serwisu, udostępnione w zakładce pn. „Warunki korzystania”, pod adresem: <em>kontakt@seniornaplus.pl</em>.

                </li>
                <li>
                    <strong>Formularz Rekrutacyjny</strong> – udostępniony w Serwisie pod adresem <a href="https://seniornaplus.pl/formularz">https://seniornaplus.pl/formularz</a> lub na stronie głównej <a href="https://seniornaplus.pl/">https://seniornaplus.pl/</a> (górna sekcja) formularz służący do złożenia aplikacji w celu podjęcia pracy u ADO. Prawidłowe wypełnienie Formularza Rekrutacyjnego oraz wyrażenie niezbędnych zgód na przetwarzanie Danych Osobowych, a także akceptacja Warunków Korzystania z Serwisu oraz Polityki Prywatności Serwisu są niezbędne do prawidłowego wysłania aplikacji.
                </li>
                <li>
                ...
                <li>
                    <strong>Formularz Kontaktowy</strong> – formularz udostępniony w Serwisie pod adresem: <a href="https://seniornaplus.pl/kontakt">https://seniornaplus.pl/kontakt</a>, umożliwiający Użytkownikom kontakt z ADO, w tym m.in. skierowanie zapytania do Serwisu. Prawidłowe wypełnienie Formularza Kontaktowego oraz wyrażenie niezbędnych zgód na przetwarzanie Danych Osobowych, a także akceptacja Warunków Korzystania z Serwisu oraz Polityki Prywatności Serwisu są niezbędne do prawidłowego wysłania zapytania.
                </li>
                <li>
                ...
                <li>
                    <strong>Pliki Cookies</strong> (tzw. „ciasteczka”) – pliki tekstowe, w których serwery Serwisu zapisują informacje na dysku twardym komputera lub urządzenia mobilnego, z którego korzysta Użytkownik. Informacje zapisane w pliku „ciasteczka”, serwer Serwisu może odczytać przy ponownym połączeniu się z tego urządzenia, lecz mogą być one odczytywane również przez inne serwery lub innych użytkowników Internetu.
                </li>
                <li>
                ...
                <li>
                    <strong>Polityka Prywatności</strong> – niniejsza polityka prywatności Serwisu udostępniona w zakładce pn. „Polityka Prywatności”, pod adresem: <a href="https://seniornaplus.pl/polityka-prywatnosci">https://seniornaplus.pl/polityka-prywatnosci</a>.
                </li>
            </ol>
            ...
            <ol>
                ...
                <li>W przypadku pytań związanych z ochroną Danych Osobowych w Serwisie prosimy o kontakt pod adresem: <a href="mailto:iod@seniornaplus.pl">iod@seniornaplus.pl</a>.</li>
            </ol>
            ...
            <ol>
                ...
                <li>Korzystając z zapisu na Newsletter Użytkownik wyraża zgodę na przetwarzanie swoich Danych Osobowych w celu otrzymywania informacji handlowych i innych treści marketingowych (art. 6 ust. 1 lit. a) RODO). Prawidłowe wypełnienie zapisu na Newsletter oraz wyrażenie niezbędnych zgód na przetwarzanie Danych Osobowych, a także akceptacja Warunków Korzystania z Serwisu oraz Polityki Prywatności Serwisu są niezbędne do rozpoczęcia świadczenia usługi wysyłania Newsletteru.</li>
            ...
            <ol>
                ...
                <li>
                    ...
                    <ol className='ml-10'>
                        ...
                        <li>pliki stałe – przechowywane przez określony czas w parametrach Plików Cookies lub do czasu ich usunięcia przez Użytkownika.</li>
                    </ol>
                </li>
                <li>
            ...
            <ol>
                ...
                <li>Jeśli opisana funkcja nie jest przez Użytkownika akceptowana, może zostać w każdej chwili dezaktywowana na stronie: <a href="https://adssettings.google.com/authenticated">https://adssettings.google.com/authenticated</a>.</li>
                ...
                <li>Dokładne informacje na temat warunków korzystania z usług Google i ochrony danych znaleźć można na: <a href="http://www.google.com/analytics/terms/de.html">http://www.google.com/analytics/terms/de.html</a> albo na <a href="https://www.google.pl/intl/pl/policies/">https://www.google.pl/intl/pl/policies/</a>.</li>
            </ol>
            ...
            <ol>
                ...
                <li>Polityka Prywatności jest dokumentem zgodnym z Warunkami Korzystania z Serwisu oraz przepisami powszechnie obowiązującego prawa.</li>
            </ol>
        </div>
        </AppLayout>
    );
